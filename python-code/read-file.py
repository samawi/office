...
report_rental_charge_df = pd.DataFrame(my_reporting_date_range, columns=['date'])   # Rental revenue
report_sc_charge_df = pd.DataFrame(my_reporting_date_range, columns=['date'])       # Service charge revenue
report_occupancy_df = pd.DataFrame(my_reporting_date_range, columns=['date'])       # Occupancy rate
